...
OhdsiRTools::checkUsagePackage("InsulinTest")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/InsulinTest.pdf")
shell("R CMD Rd2pdf ./ --output=extras/InsulinTest.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "InsulinTest",
                                mode = "description",
